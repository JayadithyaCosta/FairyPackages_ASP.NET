...
using FairyWeddings.Reservations.Data;
using FairyWeddings.Reservations.Services;
...
namespace FairyWeddings.Reservations.Controllers
{
    ...
    public class ReservationsController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult Post([FromBody] Models.Reservations reservations)
        {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] Models.Reservations reservations)
        {
